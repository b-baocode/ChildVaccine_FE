...
function ChildProfiles() {
  ...
  const [selectedChildVaccinations, setSelectedChildVaccinations] =
    useState(null);
  ...
  const handleSave = async () => {
    try {
      ...
      await childService.updateChildProfile(
  ...
  const handleConfirmDelete = async () => {
    try {
      ...
      const newProfiles = childProfiles.filter(
        ...
        <div className="reactions-modal-overlay">
          <div className="reactions-modal">
            ...
            <div className="reactions-modal-content">
              {selectedVaccination.reactions &&
              selectedVaccination.reactions.length > 0 ? (
                  ...
                  <tbody>
                    {selectedVaccination.reactions.map((reaction, index) => (
                      <tr key={index}>
                        ...
                        <td>
                          <span
                            className={`severity-badge ${reaction.severity.toLowerCase()}`}
                          >
                            {reaction.severity}
                          </span>
                        </td>
            ...
            <div className="medical-modal-content">
              ...
              selectedChildVaccinations.vaccinations.length > 0 ? (
                <table className="vaccinations-table">
                  ...
                  <tbody>
                    {selectedChildVaccinations.vaccinations.map(
                      (vaccination) => (
                ...
                <div className="edit-form">
                  ...
                  <div className="form-group">
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setEditedInfo({ ...editedInfo, weight: e.target.value })
                      }
                    />
                  </div>
                  <div className="form-group">
                ...
                <>
                  <div className="medical-info">
                    <p>
                      ...
                      {selectedMedicalRecord.basicInfo.height} cm
                    </p>
                    <p>
                      <strong>Cân nặng:</strong>{" "}
                      {selectedMedicalRecord.basicInfo.weight} kg
                    </p>
                    <p>
                      <strong>Nhóm máu:</strong>{" "}
                      {selectedMedicalRecord.basicInfo.bloodType ||
                        "Chưa có thông tin"}
                    </p>
                    <p>
                      <strong>Dị ứng:</strong>{" "}
                      {selectedMedicalRecord.basicInfo.allergies}
                    </p>
                    <p>
                      <strong>Ghi chú sức khỏe:</strong>{" "}
                      {selectedMedicalRecord.basicInfo.healthNote}
                    </p>
                  </div>
                  <div className="modal-actions">
