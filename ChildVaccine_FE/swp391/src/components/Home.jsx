  ...
  const TopBanner = () => (
    <div className="top-banner">
      ...
      <div className="banner-actions">
        <a
          href="https://play.google.com/store/apps/details?id=com.eco.eplus&hl=vi"
    ...
    const fetchUpcomingAppointments = async () => {
      ...
      try {
        ...
        try {
          ...
          console.log("Sending reminder emails for customer:", cusId);
          await appointmentService.sendReminderEmails(cusId);
        } catch (emailError) {
          console.log("Failed to send reminder emails:", emailError);
        }

        // Get all appointments for this customer
        let appointments = [];
        try {
          const response = await appointmentService.getAppointmentsByCustomerId(
        ...
        if (appointments && appointments.length > 0) {
          ...
          filteredAppointments.sort((a, b) => {
            ...
            // If dates are equal, sort by appointment time
            ...
            return (
              getMinutes(a.appointmentTime) - getMinutes(b.appointmentTime)
            ); // Sửa từ timeSlot thành appointmentTime
          });
    ...
    <div className="home">
        ...
        <ul>
          ...
          {user && user.role === "CUSTOMER" && (
            <>
              ...
              <li onClick={() => navigate("/react-report")}>
                PHẢN ỨNG SAU TIÊM
              </li>
            </>
          )}
              ...
              <div className="notification-content">
                ...
                {upcomingAppointment ? (
                  <span className="notification-text">
                    Bạn có buổi hẹn sắp tới vào{" "}
                    {new Date(
                      upcomingAppointment.appointmentDate
                    ).toLocaleDateString("vi-VN")}{" "}
                    vào lúc {upcomingAppointment.appointmentTime} -{" "}
                    {upcomingAppointment.appId}
                  </span>
                ) : (
                  <span className="notification-text">
      ...
      <div className="slider-section">
        ...
        >
          <div>
            <img
              src="https://cdn.nhathuoclongchau.com.vn/unsafe/1920x0/filters:quality(90)/https://cms-prod.s3-sgn09.fptcloud.com/1440_X490_fc8b6c0e72.jpg"
              alt="Slide 1"
            />
          </div>
          <div>
            <img
              src="https://cdn.nhathuoclongchau.com.vn/unsafe/1920x0/filters:quality(90)/https://cms-prod.s3-sgn09.fptcloud.com/Banner_web_SXH_T11_1440x490_eb49d92a40.jpg"
              alt="Slide 2"
            />
          </div>
          <div>
            <img
              src="https://cdn.nhathuoclongchau.com.vn/unsafe/1920x0/filters:quality(90)/https://cms-prod.s3-sgn09.fptcloud.com/1440x490_4d5a2e57da.png"
              alt="Slide 3"
            />
          </div>
          <div>
            <img
              src="https://cdn.nhathuoclongchau.com.vn/unsafe/1920x0/filters:quality(90)/https://cms-prod.s3-sgn09.fptcloud.com/BANNERWEB_6_IN_1_FR_1_1440x490_137ec11ded.png"
              alt="Slide 4"
            />
          </div>
        </Carousel>
