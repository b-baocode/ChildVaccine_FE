            ...
            try {
                ...
                if (appointments && appointments.length > 0) {
                    ...
                    filteredAppointments.sort((a, b) => {
                        ...
                        return getMinutes(a.appointmentTime) - getMinutes(b.appointmentTime); // Sửa từ timeSlot thành appointmentTime
                    });
                            ...
                            <div className="notification-content">
                                ...
                                {upcomingAppointment ? (
                                    <span className="notification-text">
                                        Bạn có buổi hẹn sắp tới vào {new Date(upcomingAppointment.appointmentDate).toLocaleDateString('vi-VN')} vào lúc {upcomingAppointment.appointmentTime} - {upcomingAppointment.appId}
                                    </span>
                                ) : (
